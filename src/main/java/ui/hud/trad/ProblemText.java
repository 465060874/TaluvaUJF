        ...
        for (Problem problem : problems) {
            switch (problem) {
                case NOT_ON_SEA_OR_VOLCANO:
                    return "La tuile a placer doit se trouver sur la mer, ou son volcan sur un autre volcan";
                case NOT_ALL_ON_SEA:
                ...
                case HUT_TOO_HIGH:
                    return "Les hutes ne peuvent être placés qu'au premier niveau";
                case TEMPLE_NOT_IN_VILLAGE_OF_3:
                    return "Les temples doivent être contigues à un village d'au moins trois cases quand elles sont placées";
                ...
                case TOWER_NOT_IN_VILLAGE:
                    return "Les tours doivent être contigues à un village quand elles sont placées";
                case NOT_A_VILLAGE:
                ...
                case EXPAND_NOT_ENOUGH_BUILDING:
                    return "Vous n'avez pas suffisament de hûtes faire cette extension de village";
            }
        }
